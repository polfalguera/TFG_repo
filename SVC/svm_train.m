...
function [a,b,g,ind,uind,X,y,Rs,Q] = svm_train(X_new,y_new,C_new,varargin)
...
%      learn(indc,0);
%      fprintf('- Example %d has been learned.\n', indc);
% 
%   end;
% 
...
% Step 2: Collect the names of the global variables
globalVars = who('global');

% Step 3: Save the global variables to a globals.mat file
save('globals.mat', globalVars{:});